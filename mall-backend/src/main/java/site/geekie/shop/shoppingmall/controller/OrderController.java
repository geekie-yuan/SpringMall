...
public class OrderController {
    ...
    public Result<List<OrderVO>> getMyOrders() {
        List<OrderVO> orders = orderService.getMyOrders();
    ...
    public Result<List<OrderVO>> getMyOrdersByStatus(@PathVariable String status) {
        List<OrderVO> orders = orderService.getMyOrdersByStatus(status);
        return Result.success(orders);
    }
